...
(function (root) {
  ...
  root.MISSIONS = [
    {
      id: 'M01', week: 1, domain: 'A-1', xp: 30,
      title: '原価センタの壁',
    ...
    {
      id: 'M02', week: 1, domain: 'A-1', xp: 30,
      title: '統制を壊さずに通す',
    ...
    {
      id: 'M03', week: 2, domain: 'A-4', xp: 40,
      title: '消費税を自動生成させる',
    ...
    {
      id: 'M04', week: 1, domain: 'A-1', xp: 50, flag: 'core',
    ...
    {
      id: 'M07', week: 2, domain: 'A-2', xp: 40,
      title: '調整勘定は誰が書くのか',
    ...
    {
      id: 'M08', week: 2, domain: 'B-1', xp: 25,
      title: '触れない勘定',
    ...
    {
      id: 'M10', week: 2, domain: 'A-2', xp: 35,
      title: '仕入先へ支払う',
